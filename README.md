...
The main Python codes are the implementation of iMapD framework<sup>[1](#imapd)</sup> which performs a manifold search (for macromolecular systems) through usage of DiffusionMap<sup>[2](#dmap)</sup> to parameterize the explored parts of underlying intrinsic manifold and then apply PCA<sup>[3](#pca)</sup> (Principal Component Analysis) to generate a data point outside. The frameowrk had shown up to 100x speed-up over plain molecular dynamics.
...
<sub>1</sub><a name="imapd"></a>[DOI:10.1073/pnas.1621481114](https://doi.org/10.1073/pnas.1621481114)\
<sub>2</sub><a name="dmap"></a>[DOI:10.1016/j.acha.2006.04.006](https://doi.org/10.1016/j.acha.2006.04.006)\
<sub>3</sub><a name="pca"></a>[DOI:10.1145/3447755](https://doi.org/10.1145/3447755)
